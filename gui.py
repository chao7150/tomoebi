...
class MyWindow(QWidget):
    ...
    def init_accounts(self):
        ...
        if os.path.isfile("auth.json"):
            ...
            twitter.open_filterstream(self.auths["PainEchos"], self.receive_tweet, "PainEchos", [str(x) for x in self.following])
        else:
            default = {
                "Twitter"  : {},
                "Mastodon" : {}
    ...
    def sethashtag(self):
        ...
        if switch.isChecked():
            ...
            self.searchstream = twitter.open_filterstream(self.auths["PainEchos"], self.receive_tweet, "PainEchos", self.receivetags)
        else:
            self.receivetags = []
            self.tweettags = []
